...
class Solution:
    ...
    def check(self, mid, weights, days):
        ...
        return False if noOfDays > days else True
...
# https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/solutions/3217557/easy-approch-using-python-java-n-log-n-binary-search/
